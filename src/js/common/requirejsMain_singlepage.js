...
var require = {
    ...
    paths : {
        ...
        */
        ...
        'zTree':'assets/lib/zTree_v3/js/jquery.ztree.all.min',
        ...
        'jquery.form':'js/common/jquery-form',
        //jquery plugins end---
        'jquery.md5':'js/common/jquery.md5',
        'cookie' : 'assets/common/cookie',
        'ajax' : 'js/common/ajax_amd',
        ...
        'base64' : 'assets/common/base64',
        /*组件*/
        'tab':'js/common/components/tab/tab',
        'list':'assets/components/list/list',
        // 'list':'js/common/myList',
