 ...
 * process 组件示例
 */
require(['process', 'text!tpl/example/component/process/val0.tpl', 'text!tpl/example/component/process/val1.tpl', 'eventTarget', 'jquery'], function(Process, tpl0, tpl1, EventTarget) {
    var config = {
