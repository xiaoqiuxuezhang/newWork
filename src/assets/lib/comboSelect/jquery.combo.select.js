...
(function (factory) {
	...
	$.extend(Plugin.prototype, {
		...
		_construct: function(){
			 ...
			 * Append b
			 */
			this.$b = $('<b>').appendTo(this.$arrow )

			/**
			 * Append dropdown
			 */

			this.$after = $('<div class="beforeAfter">')

			this.$dropdown = $('<ul class="'+this.settings.comboDropDownClass+'" />').appendTo(this.$after)
			
			this.$after.appendTo(this.$container)
