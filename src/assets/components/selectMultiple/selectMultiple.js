...
define('text!components/selectMultiple/selectMultiple.tpl',[],function () { return '<div class="{{className}}">\r\n\t{{#if label}}<label>{{label}}</label>{{/if}}<select class="sn-select2" name="{{name}}"></select>\r\n</div>';});


define('lib/requirejs/css.min!lib/select2/select2',[],function(){});

define('lib/requirejs/css.min!components/selectMultiple/selectMultiple',[],function(){});
/**
 * 组件-selectMultiple
 */
define('selectMultiple',['eventTarget','hdb','select2', 
    	'text!components/selectMultiple/selectMultiple.tpl',
    	'lib/requirejs/css.min!lib/select2/select2.css',
    	'lib/requirejs/css.min!components/selectMultiple/selectMultiple.css'
    	...
    	var objClass =function(config){
        	...
        	if(this.options.enableDynamicSearch && this.options.enableDynamicSearch == "1"){
        		if(this.options.url && this.options.url != ""){
			    	...
			    	contentSet.escapeMarkup = function (markup) { return markup; };
			    	contentSet.minimumInputLength = 1;
			    	// escapeMarkup: function (markup) { return markup; },
        				// minimumInputLength: 1,	
			}else{console.log("请配置请求字段名。");}
