...
define('text!components/timer/timer.tpl',[],function () { return '<div class="sn-timer">\r\n\t <span></span>\r\n</div>';});


define('lib/requirejs/css.min!components/timer/timer',[],function(){});
/**
 * 组件-timer
 */
define('timer',['eventTarget', 
    'text!components/timer/timer.tpl',
    'lib/requirejs/css.min!components/timer/timer.css','jquery'
    ...
    $.extend(objClass.prototype, EventTarget.prototype, {
        ...
        start: function() {
            ...
            var $timer = this.$el.find('.' + this.options.className + '>span'),
