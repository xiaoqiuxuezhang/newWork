define('components/satisfyStar/satisfyStar.tpl',['hdbr'], function(Handlebars) {
			return Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    return "		<!-- <li></li> -->\r\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=helpers.helperMissing;

  return "<ul class = \"sn-satisfyStar "
    + container.escapeExpression(((helper = (helper = helpers.className || (depth0 != null ? depth0.className : depth0)) != null ? helper : alias2),(typeof helper === "function" ? helper.call(alias1,{"name":"className","hash":{},"data":data}) : helper)))
    + "\">\r\n"
    + ((stack1 = (helpers["for"] || (depth0 && depth0["for"]) || alias2).call(alias1,(depth0 != null ? depth0.amounts : depth0),{"name":"for","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</ul>";
},"useData":true})
		});
 ...
 * 组件-satisfyStar
 */
define('satisfyStar',['eventTarget', 
	'hdbr',
    'components/satisfyStar/satisfyStar.tpl',
...
//                 me.$el.find('ul li').removeClass("select");
        ...
        this.$el.on("mouseout", "li", function() {
